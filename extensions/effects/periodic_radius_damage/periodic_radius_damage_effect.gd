...
func apply(player_index: int) -> void:
	...
	effects[key_hash].append([value, value2, scaling_stats, base_cooldown, base_damage, tracked_key_hash, damage_color_hash, hit_visual_scene_hash, can_light])
...
func serialize() -> Dictionary:
	...
	serialized.can_light = can_light
